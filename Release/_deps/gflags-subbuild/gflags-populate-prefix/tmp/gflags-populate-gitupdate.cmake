...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.2.2"
  WORKING_DIRECTORY "/home/baotong/bztree/Release/_deps/gflags-src"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/baotong/bztree/Release/_deps/gflags-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/baotong/bztree/Release/_deps/gflags-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
